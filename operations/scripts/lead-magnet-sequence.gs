...
const LEAD_MAGNET_SEQUENCE_SHEET_ID = 'YOUR_SHEET_ID_HERE';
const LEAD_MAGNET_SEQUENCE_FROM_EMAIL = 'team@outboundsolved.com';
const LEAD_MAGNET_SEQUENCE_CALENDLY_LINK = 'https://calendly.com/outboundsolved/15min';
...
function doPost(e) {
  try {
    ...
    // Log to Leads tab
    var ss = SpreadsheetApp.openById(LEAD_MAGNET_SEQUENCE_SHEET_ID);
